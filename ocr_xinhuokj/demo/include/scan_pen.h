...
public:  
  ...
  int DetectLines(const Frame& line_image, std::vector<LineItem>& char_items);

  // 识别文本航图像，支持BGR，RGB图像格式
  // int RecogLine(const cv::Mat& line_image, std::vector<CharItem>& char_items);
